...
alert(a);
// переменная А не определена, if имеет значение false
...
// вывод тела функции " function a(x) {  return x * 2; }"
...
// window ? функция замыкания?


/* Задание 1. Змейка */
// Для практикума из занятия 7 продумать, где можно применить замыкания.
// Ответ: замыкания можно использовать везде, где вы обычно использовали объект с одним единственным методом
